...
<!-- wp:column --><div class="wp-block-column"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading"><?php echo esc_html_x( 'Understand', 'Learning checkpoint heading', 'slateframe' ); ?></h3><!-- /wp:heading --><!-- wp:list {"className":"is-style-slateframe-checklist"} --><ul class="wp-block-list is-style-slateframe-checklist"><li><?php echo esc_html_x( 'Explain the central idea in your own words.', 'Learning checklist item', 'slateframe' ); ?></li><li><?php echo esc_html_x( 'Identify the assumptions and limits that matter.', 'Learning checklist item', 'slateframe' ); ?></li></ul><!-- /wp:list --></div><!-- /wp:column -->
<!-- wp:column --><div class="wp-block-column"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading"><?php echo esc_html_x( 'Practise', 'Learning checkpoint heading', 'slateframe' ); ?></h3><!-- /wp:heading --><!-- wp:list {"className":"is-style-slateframe-checklist"} --><ul class="wp-block-list is-style-slateframe-checklist"><li><?php echo esc_html_x( 'Apply the idea to one concrete example.', 'Learning checklist item', 'slateframe' ); ?></li><li><?php echo esc_html_x( 'Record one question to revisit later.', 'Learning checklist item', 'slateframe' ); ?></li></ul><!-- /wp:list --></div><!-- /wp:column -->
</div><!-- /wp:columns -->
